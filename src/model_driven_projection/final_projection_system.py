...
class FinalProjectionSystem:
    ...
    def _extract_with_all_fixes(self, tree: ast.AST, file_path: str) -> List[CodeNode]:
        ...
        function_nodes = self._extract_standalone_functions_fixed(tree, file_path, context)
    ...
    def _extract_classes_with_methods_fixed(self, tree: ast.AST, file_path: str, context: str) -> List[CodeNode]:
    ...
    def _extract_standalone_functions_fixed(self, tree: ast.AST, file_path: str, context: str) -> List[CodeNode]:
        ...
        for line in lines:
            if 'assert ' in line:
                ...
                if 'assert timeout_minutes is not None' in line:
                    ...
                    fixed_lines.append("            raise ValueError('session_timeout_minutes should be set')")
                else:
...
def main():
    ...
    if Path(test_file).exists():
        ...
        if projected_content:
            ...
            print(f"✅ Saved final projection to final_projection.py")
