...
class TestSecurityManager:
    ...
    def test_session_validation_expired_token(self):
        ...
        expired_token = jwt.encode(payload, SECURITY_CONFIG["jwt_secret"], algorithm="HS256")
...
class TestDeploymentManager:
    ...
    @patch('boto3.client')
    def test_deploy_stack_success(self, mock_boto3_client):
    ...
    @patch('boto3.client')
    def test_deploy_stack_failure(self, mock_boto3_client):
    ...
    @patch('boto3.client')
    def test_get_stack_status(self, mock_boto3_client):
    ...
    @patch('boto3.client')
    def test_get_stack_events(self, mock_boto3_client):
...
class TestPydanticModels:
    ...
    def test_snowflake_config_invalid_url(self):
    ...
    def test_openflow_config_invalid_uuid(self):
