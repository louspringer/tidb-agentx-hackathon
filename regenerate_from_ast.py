...
def main():
    ...
    # Files to regenerate
    files_to_regenerate = [
        ("src/streamlit/openflow_quickstart_app.py", "src/streamlit/openflow_quickstart_app.py"),
        ("src/security_first/input_validator.py", "src/security_first/input_validator.py"),
